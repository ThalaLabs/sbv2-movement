...
const aggregatorAddress = "0x42c29c43eeb78a95c1facc8ff96827f51bc346eb5bc07bf6528748d756d80647";
...
const { responses, updates, updateTx } = await aggregator.fetchUpdate({sender: account.accountAddress.toString()});
