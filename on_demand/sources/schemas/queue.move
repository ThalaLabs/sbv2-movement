module on_demand::queue {

    friend on_demand::guardian_queue_init_action;
    friend on_demand::oracle_queue_init_action;
    friend on_demand::oracle_init_action;
    friend on_demand::oracle_attest_action;
    friend on_demand::queue_override_oracle_action;
    friend on_demand::queue_add_fee_coin_action;
    friend on_demand::queue_remove_fee_coin_action;
    friend on_demand::queue_set_configs_action;
    friend on_demand::queue_set_authority_action;
    friend on_demand::aggregator_init_action;
    friend on_demand::aggregator_submit_result_action;
    friend on_demand::update_action;
